...
if (isset($_POST['nome'])) {
    ...
    echo "Nome		=" . $nome . "</br>";
    echo "Email		=" . $email . "</br>";
    echo "Observa̤̣o	=" . $observacao . "</br>";
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                ...
                <div class="span10">
                    ...
                    <legend class="breadcrumb">Novo orientador</legend>
                    ...
                    <script>
                        $(function() {
                            ...
                            $("button#submit").click(function() {
                                $.ajax({
                                    type: "POST",
                                    url: "orientador_cadastrar.php",
                                    data: $('form.orientador').serialize(),
