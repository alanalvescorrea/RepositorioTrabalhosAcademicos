                        ...
                        <fieldset>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <?php /*echo 'cadastrar'; */?> 
                                    <?php /*echo '<a href="instituicao_cadastrar.php" target="_blank"> nova institui̤̣o</a>'; */?>
                                    <a href="#" onclick="window.open('instituicao_cadastrar.php', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=10, LEFT=10, WIDTH=1000, HEIGHT=500');">Cadastrar Institui̤̣o</a>
